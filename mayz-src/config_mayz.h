...
/* Version number of the MAYZ toolkit */
#define MAYZ_VERSION "2.4.4"
...
#define PACKAGE_NAME "enju"

/* Define to the full name and version of this package. */
#define PACKAGE_STRING "enju 2.4.4"

/* Define to the one symbol short name of this package. */
#define PACKAGE_TARNAME "enju"
