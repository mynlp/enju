...
#ifndef __PSTL_CONTAINER_CONCEPTS_H
#define __PSTL_CONTAINER_CONCEPTS_H


#include "pstl_concept_checks.h"

#ifdef __PSTL_USE_CONCEPT_CHECKS
...
struct _ERROR_IN_PSTL_CONTAINER {
...
__PSTL_TYPEDEF_REQUIREMENT(iterator);
__PSTL_TYPEDEF_REQUIREMENT(const_iterator);
...
struct _Container_concept_specification {
	...
	// Valid Expressions
	_ERROR_IN_PSTL_CONTAINER::__const_begin_iterator_accessor_requirement_violation(__c);
	_ERROR_IN_PSTL_CONTAINER::__const_end_iterator_accessor_requirement_violation(__c);
	_ERROR_IN_PSTL_CONTAINER::__begin_iterator_accessor_requirement_violation(__c);
	_ERROR_IN_PSTL_CONTAINER::__end_iterator_accessor_requirement_violation(__c);
	_ERROR_IN_PSTL_CONTAINER::__size_function_requirement_violation(__c);
	_ERROR_IN_PSTL_CONTAINER::__max_size_function_requirement_violation(__c);
	_ERROR_IN_PSTL_CONTAINER::__empty_function_requirement_violation(__c);
	_ERROR_IN_PSTL_CONTAINER::__swap_function_requirement_violation(__c);
...
__PSTL_TYPEDEF_REQUIREMENT(reverse_iterator);
__PSTL_TYPEDEF_REQUIREMENT(const_reverse_iterator);
...
struct _ReversibleContainer_concept_specification {
	...
	// Valid Expressions
	_ERROR_IN_PSTL_CONTAINER::__const_rbegin_iterator_accessor_requirement_violation(__c);
	_ERROR_IN_PSTL_CONTAINER::__const_rend_iterator_accessor_requirement_violation(__c);
	_ERROR_IN_PSTL_CONTAINER::__rbegin_iterator_accessor_requirement_violation(__c);
	_ERROR_IN_PSTL_CONTAINER::__rend_iterator_accessor_requirement_violation(__c);
	// Requirements on Iterators
...
struct _RandomAccessContainer_concept_specification {
	...
	typedef typename _RandomAccessContainer::bit_type _Bit;
	typedef ptr<Type, _Bit> _TypePtr;
	typedef typename _Mutable_trait<_Dist>::_Type Dist;
	_PSTL_ERROR::__element_access_operator_requirement_violation(__c,
								     _TypePtr(), 
								     Dist());
	// Requirements on Iterators
...
#endif /* if __PSTL_USE_CONCEPT_CHECKS */

#endif /* __PSTL_CONTAINER_CONCEPTS_H */
