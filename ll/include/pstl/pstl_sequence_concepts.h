...
#ifndef PSTL_SEQUENCE_CONCEPTS_H
#define PSTL_SEQUENCE_CONCEPTS_H

#include "pstl_container_concepts.h"
...
struct _ERROR_IN_PSTL_SEQ {
  ...
  __fill_default_constructor_requirement_violation(_XX &__s) {
    _PSTL_ERROR::__default_constructor_requirement_violation(*__s.begin());
    typename _XX::difference_type __n = typename _XX::difference_type();
    _XX __x(__n);
    __sink_unused_warning(__x);
  }  
...
_Sequence_requirement_violation(_Sequence __s) {
  ...
  // Valid Expressions
  _ERROR_IN_PSTL_SEQ::__fill_constructor_requirement_violation(__s);
  _ERROR_IN_PSTL_SEQ::__fill_default_constructor_requirement_violation(__s);
  _ERROR_IN_PSTL_SEQ::__range_constructor_requirement_violation(__s);
  _ERROR_IN_PSTL_SEQ::__insert_function_requirement_violation(__s);
  _ERROR_IN_PSTL_SEQ::__fill_insert_function_requirement_violation(__s);
  _ERROR_IN_PSTL_SEQ::__range_insert_function_requirement_violation(__s);
  _ERROR_IN_PSTL_SEQ::__erase_function_requirement_violation(__s);
  _ERROR_IN_PSTL_SEQ::__range_erase_function_requirement_violation(__s);
  _ERROR_IN_PSTL_SEQ::__front_function_requirement_violation(__s);
}
};
...
_FrontInsertionSequence_requirement_violation(_FrontInsertionSequence __s) {
  ...
  // Valid Expressions
  _ERROR_IN_PSTL_SEQ::__push_front_function_requirement_violation(__s);
  _ERROR_IN_PSTL_SEQ::__pop_front_function_requirement_violation(__s);
}
};
...
_BackInsertionSequence_requirement_violation(_BackInsertionSequence __s) {
  ...
  // Valid Expressions
  _ERROR_IN_PSTL_SEQ::__back_function_requirement_violation(__s);
  _ERROR_IN_PSTL_SEQ::__push_back_function_requirement_violation(__s);
  _ERROR_IN_PSTL_SEQ::__pop_back_function_requirement_violation(__s);
}
};
...
#endif /* PSTL_SEQUENCE_CONCEPTS_H */
