...
#ifndef __PSTL_CONCEPT_CHECKS_H
#define __PSTL_CONCEPT_CHECKS_H
...
/*
  ...
  for the PSTL containers:
  pstl_container_concepts.h
  pstl_sequence_concepts.h
...
#ifndef __PSTL_USE_CONCEPT_CHECKS
...
#define __PSTL_REQUIRES(__type_var, __concept) do {} while(0)
#define __PSTL_CLASS_REQUIRES(__type_var, __concept)	\
    static int  __##__type_var##_##__concept
#define __PSTL_CONVERTIBLE(__type_x, __type_y) do {} while(0)
#define __PSTL_REQUIRES_SAME_TYPE(__type_x, __type_y) do {} while(0)
#define __PSTL_CLASS_REQUIRES_SAME_TYPE(__type_x, __type_y)	\
    static int  __##__type_x##__type_y##_require_same_type
#define __PSTL_GENERATOR_CHECK(__func, __ret) do {} while(0)
#define __PSTL_CLASS_GENERATOR_CHECK(__func, __ret)	\
    static int  __##__func##__ret##_generator_check
#define __PSTL_UNARY_FUNCTION_CHECK(__func, __ret, __arg) do {} while(0)
#define __PSTL_CLASS_UNARY_FUNCTION_CHECK(__func, __ret, __arg) \
    static int  __##__func##__ret##__arg##_unary_function_check
#define __PSTL_BINARY_FUNCTION_CHECK(__func, __ret, __first, __second)	\
    do {} while(0)
#define __PSTL_CLASS_BINARY_FUNCTION_CHECK(__func, __ret, __first, __second) \
    static int  __##__func##__ret##__first##__second##_binary_function_check
#define __PSTL_REQUIRES_BINARY_OP(__opname, __ret, __first, __second)	\
    do {} while(0)
#define __PSTL_CLASS_REQUIRES_BINARY_OP(__opname, __ret, __first, __second) \
    static int __##__opname##__ret##__first##__second##_require_binary_op

#else /* __PSTL_USE_CONCEPT_CHECKS */
...
#define __PSTL_REQUIRES(__type_var, __concept)				\
    do {								\
	void (*__x)( __type_var ) = __concept##_concept_specification< __type_var > \
	    ::__concept##_requirement_violation; __x = __x; } while (0)

// Use this to check whether type X is convertible to type Y
#define __PSTL_CONVERTIBLE(__type_x, __type_y)				\
    do {								\
	void (*__x)( __type_x , __type_y ) = _PSTL_CONVERT_ERROR< __type_x , \
	    __type_y >::__type_X_is_not_convertible_to_type_Y;		\
	__x = __x; } while (0)

// Use this to test whether two template arguments are the same type
#define __PSTL_REQUIRES_SAME_TYPE(__type_x, __type_y)			\
    do {								\
	void (*__x)( __type_x , __type_y ) = _PSTL_SAME_TYPE_ERROR< __type_x, \
	    __type_y  >::__type_X_not_same_as_type_Y;			\
	__x = __x; } while (0)


// function object checks
#define __PSTL_GENERATOR_CHECK(__func, __ret)			\
    do {							\
	__ret (*__x)( __func&) =				\
	    _PSTL_GENERATOR_ERROR<				\
	__func, __ret>::__generator_requirement_violation;	\
	__x = __x; } while (0)


#define __PSTL_UNARY_FUNCTION_CHECK(__func, __ret, __arg)		\
    do {								\
	__ret (*__x)( __func &, const __arg &) =				\
	    _PSTL_UNARY_FUNCTION_ERROR<					\
...
#define __PSTL_CLASS_REQUIRES_SAME_TYPE(__type_x, __type_y)		\
    ...
    static __dummy_struct_##__type_x##__type_y##_same_type<		\
							    _PSTL_SAME_TYPE_ERROR<__type_x, __type_y>::__type_X_not_same_as_type_Y> \
...
#define __PSTL_CLASS_BINARY_FUNCTION_CHECK(__func, __ret, __first, __second) \
    ...
    static __dummy_struct_##__func##__ret##__first##__second##_binary_check< \
									     _PSTL_BINARY_FUNCTION_ERROR<__func, __ret, __first, __second>:: \
...
struct _PSTL_GENERATOR_ERROR<_Func, void> {
...
struct _PSTL_UNARY_FUNCTION_ERROR {
    static _Ret
...
struct _PSTL_UNARY_FUNCTION_ERROR<_Func, void, _Arg> {
    static void
    __unary_function_requirement_violation(_Func &__f,
					   const _Arg &__arg) {
	__f(__arg);
...
struct _PSTL_BINARY_FUNCTION_ERROR {
    static _Ret
...
struct _PSTL_BINARY_FUNCTION_ERROR<_Func, void, _First, _Second> {
    static void
    __binary_function_requirement_violation(_Func &__f,
					    const _First &__first, 
					    const _Second &__second) {
...
#define __PSTL_DEFINE_BINARY_OP_CHECK(_OP, _NAME)			\
    template <class _Ret, class _First, class _Second>			\
    struct _PSTL_BINARY##_NAME##_ERROR {				\
	static _Ret							\
...
__PSTL_DEFINE_BINARY_OP_CHECK(==, _OP_EQUAL);
__PSTL_DEFINE_BINARY_OP_CHECK(!=, _OP_NOT_EQUAL);
__PSTL_DEFINE_BINARY_OP_CHECK(<, _OP_LESS_THAN);
__PSTL_DEFINE_BINARY_OP_CHECK(<=, _OP_LESS_EQUAL);
__PSTL_DEFINE_BINARY_OP_CHECK(>, _OP_GREATER_THAN);
__PSTL_DEFINE_BINARY_OP_CHECK(>=, _OP_GREATER_EQUAL);
__PSTL_DEFINE_BINARY_OP_CHECK(+, _OP_PLUS);
__PSTL_DEFINE_BINARY_OP_CHECK(*, _OP_TIMES);
__PSTL_DEFINE_BINARY_OP_CHECK(/, _OP_DIVIDE);
__PSTL_DEFINE_BINARY_OP_CHECK(-, _OP_SUBTRACT);
__PSTL_DEFINE_BINARY_OP_CHECK(%, _OP_MOD);
// ...
...
struct _PSTL_ERROR {
	...
	*__i++ = __t;
    ...
    template <class _Exp, class _Type, class _Distance, class _Bit>
    static _Type
    __element_access_operator_requirement_violation(_Exp __x, ptr<_Type, _Bit>,
						    _Distance __n) {
	return __x[__n];
    }
    template <class _Exp, class _Type, class _Distance, class _Bit>
...
struct __value_type_type_definition_requirement_violation {
    typedef typename pstl::iterator_traits<_Iter>::value_type value_type;
};

template <class _Iter> 
struct __difference_type_type_definition_requirement_violation {
    typedef typename pstl::iterator_traits<_Iter>::difference_type
    difference_type;
};

template <class _Iter> 
struct __reference_type_definition_requirement_violation {
    typedef typename pstl::iterator_traits<_Iter>::reference reference;
};

template <class _Iter> 
struct __pointer_type_definition_requirement_violation {
    typedef typename pstl::iterator_traits<_Iter>::pointer pointer;
};

template <class _Iter> 
struct __iterator_category_type_definition_requirement_violation {
    typedef typename pstl::iterator_traits<_Iter>::iterator_category 
    iterator_category;
};
...
struct _Assignable_concept_specification {
	...
	_PSTL_ERROR::__assignment_operator_requirement_violation(__a);
	_PSTL_ERROR::__copy_constructor_requirement_violation(__a);
	_PSTL_ERROR::__const_parameter_required_for_copy_constructor(__a,__a);
	_PSTL_ERROR::__const_parameter_required_for_assignment_operator(__a,__a);
    }
};
...
struct _DefaultConstructible_concept_specification {
	...
	_PSTL_ERROR::__default_constructor_requirement_violation(__a);
    }
};
...
struct _EqualityComparable_concept_specification {
	...
	_PSTL_ERROR::__equality_comparable_requirement_violation(__a, __a);
    }
};
...
struct _LessThanComparable_concept_specification {
	...
	_PSTL_ERROR::__less_than_comparable_requirement_violation(__a, __a);
    }
};
...
struct _TrivialIterator_concept_specification {
	...
	// Valid Expressions
	_PSTL_ERROR::__dereference_operator_requirement_violation(__i);
    }
};
...
struct _Mutable_TrivialIterator_concept_specification {
	...
	// Valid Expressions
	_PSTL_ERROR::__dereference_operator_and_assignment_requirement_violation(__i);
    }
};
...
struct _InputIterator_concept_specification {
	...
	// Valid Expressions
	_PSTL_ERROR::__preincrement_operator_requirement_violation(__i);
	// CANNOT use the postincrement operator of PSTL iterators
	// _PSTL_ERROR::__postincrement_operator_requirement_violation(__i);
    }
};
...
struct _BidirectionalIterator_concept_specification {
	...
	_ForwardIterator_concept_specification<_BidirectionalIterator>::
	    _ForwardIterator_requirement_violation(__i);
	// Valid Expressions
	_PSTL_ERROR::__predecrement_operator_requirement_violation(__i);
	// CANNOT use the postincrement operator of PSTL iterators
	// _PSTL_ERROR::__postdecrement_operator_requirement_violation(__i);
    }
};
...
struct _Mutable_BidirectionalIterator_concept_specification {
	...
	_BidirectionalIterator __i)
	{
	    ...
	    ptr<typename _Mutable_trait<__T>::_Type, typename _BidirectionalIterator::bit_type> __tmp_ptr = 0;
	    // Valid Expressions
...
struct _RandomAccessIterator_concept_specification {
	...
	// Valid Expressions
	_PSTL_ERROR::__iterator_addition_assignment_requirement_violation(__i,
									  _MutDist());
	_PSTL_ERROR::__iterator_addition_requirement_violation(__i,
							       _MutDist());
	_PSTL_ERROR::
	    __iterator_subtraction_assignment_requirement_violation(__i,
								    _MutDist());
	_PSTL_ERROR::__iterator_subtraction_requirement_violation(__i,
								  _MutDist());
	_PSTL_ERROR::__difference_operator_requirement_violation(__i, __i,
								 _MutDist());

	ptr<typename _Mutable_trait<value_type>::_Type, typename _RandAccIter::arch_type>  __dummy_ptr = 0;
	_PSTL_ERROR::__element_access_operator_requirement_violation(__i,
								     __dummy_ptr,
								     _MutDist());
    }
};
...
struct _Mutable_RandomAccessIterator_concept_specification {
    ...
    _Mutable_RandomAccessIterator_requirement_violation(_RandAccIter __i)
	{
	    ...
	    ptr<typename _Mutable_trait<value_type>::_Type, typename _RandAccIter::arch_type> __tmp_ptr = 0;
	    // Valid Expressions
	    _PSTL_ERROR::__element_assignment_operator_requirement_violation(__i,
									     __tmp_ptr, _Dist());
	}
};

#define __PSTL_TYPEDEF_REQUIREMENT(__REQUIREMENT)		\
    template <class Type>					\
    struct __##__REQUIREMENT##__typedef_requirement_violation { \
	typedef typename Type::__REQUIREMENT __REQUIREMENT;	\
    }

__PSTL_TYPEDEF_REQUIREMENT(value_type);
__PSTL_TYPEDEF_REQUIREMENT(difference_type);
__PSTL_TYPEDEF_REQUIREMENT(size_type);
__PSTL_TYPEDEF_REQUIREMENT(reference);
__PSTL_TYPEDEF_REQUIREMENT(const_reference);
__PSTL_TYPEDEF_REQUIREMENT(pointer);
__PSTL_TYPEDEF_REQUIREMENT(const_pointer);
...
struct _Allocator_concept_specification {
	...
	//__PSTL_REQUIRES_SAME_TYPE(typename _Alloc::__PSTL_TEMPLATE rebind<_Tp>::other,
	//                         _Alloc);
    }
};

#endif /* __PSTL_USE_CONCEPT_CHECKS */

__PSTL_END_NAMESPACE

#endif /* __PSTL_CONCEPT_CHECKS_H */
